...
public class Categoria implements Serializable { //serializacion porque se va almacenar ciertos datos en el disco
    ...
    @OneToMany //de categoria a productos es  de uno a muchos, porque una categoria tiene muchos productos
    @JoinColumn(name="id_categoria", updatable=false)//esta es la union con la tabla de productos es la clave foranea
